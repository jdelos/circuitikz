...
\def\pgf@circ@gnst@path#1{\pgf@circ@bipole@path{gnst}{#1}} %  Iss1: J.Delos Added Generic switch
\def\pgf@circ@clst@path#1{\pgf@circ@bipole@path{clst}{#1}} %  Iss2: J.Delos Added closed switch
...
\def\pgf@circ@voltmeterV@path#1{\pgf@circ@bipole@path{voltmeterV}{#1}} % Iss3: J.Delos Added Vertical voltmeter
...
\compattikzset{gswitch/.style = {\circuitikzbasekey, /tikz/to path=\pgf@circ@gnst@path, l=#1}} % Iss1: J.Delos Added Generic switch
\compattikzset{cswitch/.style = {\circuitikzbasekey, /tikz/to path=\pgf@circ@clst@path, l=#1}} % Iss2: J.Delos Added closed switch
...
\compattikzset{voltmeterV/.style = {\circuitikzbasekey, /tikz/to path=\pgf@circ@voltmeterV@path}} % Iss3: J. Delos vertical voltmeter 
...
\compattikzset{gnst/.style = {gswitch = #1}} % Iss1: J.Delos Added Generic switch
\compattikzset{clst/.style = {cswitch = #1}} % Iss2: J.Delos Added closed switch
